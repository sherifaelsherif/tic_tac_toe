...
void RegisterWindowTest::testPasswordStrengthWeak() {
    ...
    QCOMPARE(window->calculatePasswordStrength("password"), QString("WEAK"));
    QCOMPARE(window->calculatePasswordStrength("123456"), QString("WEAK"));
}

void RegisterWindowTest::testPasswordStrengthMedium() {
    QCOMPARE(window->calculatePasswordStrength("Password1"), QString("MEDIUM"));
    QCOMPARE(window->calculatePasswordStrength("password123"), QString("MEDIUM"));
    QCOMPARE(window->calculatePasswordStrength("PASSWORD123"), QString("MEDIUM"));
}
...
void RegisterWindowTest::testPasswordStrengthStrong() {
    ...
    QCOMPARE(window->calculatePasswordStrength("StrongPass123#"), QString("STRONG"));
}
...
void RegisterWindowTest::testPasswordStrengthUpdate() {
    ...
    passwordEdit->setText("Medium123");
    window->updatePasswordStrength();
    QVERIFY(strengthLabel->text().contains("MEDIUM"));
    
    // Test strong password
    passwordEdit->setText("Strong123!");
    window->updatePasswordStrength();
